...
function setGame() {
    ...
    for(let r = 0; r < rows; r++) {
        for(let c = 0; c < columns; c++) {
            // This creates a div tag like this : <div id="0-0"> </div>
...
function setTwo() {
    ...
    while(!found) {
        // random r, c
        let r = Math.floor(Math.random() * rows);// math.random gives yoou a num 0-1, we * by 4 (4 rows) 
        // rounds to get 0 instead of a decimal
